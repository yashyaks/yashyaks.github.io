...
<div className="relative overflow-hidden">
  <div className="max-w-[75rem] px-4 py-12 sm:px-6 lg:px-8 lg:py-16 mx-auto">
  <div className='font-Poppins block text-2xl font-bold text-gray-800 sm:text-3xl lg:text-4xl xl:text-5xl lg:leading-tight text-white mb-8'>Experience</div>
    {/* <!-- Grid --> */}
