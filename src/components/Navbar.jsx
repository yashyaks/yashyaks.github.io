    ...
    <>
      <header className='relative max-w-[95rem] w-full mx-auto px-10 pb-10 pt-9 flex justify-between items-center'>
        <div className="flex items-center w-full justify-between">
          ...
          <a className="flex text-2xl lg:text-2xl font-semibold font-Poppins text-white  mx-auto lg:mx-0">
          <Link to="/">
            <img src="/Dark.png" alt="Description" className="w-[170px] h-[42px] sm:w-[255px] sm:h-[64px] lg:mr-2" />
          </Link>
          </a>
        </div>
